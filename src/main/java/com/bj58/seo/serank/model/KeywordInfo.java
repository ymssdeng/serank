...
public class KeywordInfo implements OceanusEntity {
  ...
  public String toString() {
    return "KeyWordInfoModel [id_keyword_info=" + id_keyword_info + ", taskid=" + taskid
        + ", exedate=" + exedate + ", id_keyword=" + id_keyword + ", keyword=" + keyword
        + ", markid=" + markid + ", se_type=" + se_type + ", business_line=" + business_line
        + ", cityid=" + cityid + ", cate1=" + cate1 + ", cate2=" + cate2 + ", cate3=" + cate3
        + ", cate4=" + cate4 + ", top=" + top + ", host=" + host + ", mainhost=" + mainhost
        + ", true_url=" + true_url + "]";
  }
